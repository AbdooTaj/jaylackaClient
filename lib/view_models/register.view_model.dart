...
class RegisterViewModel extends MyBaseViewModel {
  ...
  TextEditingController nameTEC =
      new TextEditingController(text: !kReleaseMode ? "محمد أحمد" : "");
  TextEditingController emailTEC =
      new TextEditingController(text: !kReleaseMode ? "mohammed@gmail.com" : "");
  TextEditingController phoneTEC =
      new TextEditingController(text: !kReleaseMode ? "000000" : "");
  ...
  void processRegister() async {
    //
    accountPhoneNumber = "+${967}${phoneTEC.text}";
    //
