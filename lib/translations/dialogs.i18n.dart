...
extension Localization on String {
  ...
  static var _t = Translations("en") +
      ...
      } +
      {
        ...
        "fr": "Option requise",
        "es": "Opción requerida",
        "de": "Option erforderlich",
        "pt": "Opção necessária",
        "ar": "الخيار المطلوب",
        "ko": "옵션 필요"
      } +
      {
        "en": "You are required to select at least one option of",
        "fr": "Vous devez sélectionner au moins une option de",
        "es": "Debe seleccionar al menos una opción de",
        "de": "Sie müssen mindestens eine Option auswählen von",
        "pt": "Você deve selecionar pelo menos uma opção de",
        "ar": "أنت مطالب بتحديد خيار واحد على الأقل من",
        "ko": "다음 중 하나 이상의 옵션을 선택해야 합니다."
      };
